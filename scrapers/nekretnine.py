...
class NekretnineScraper(Thread):
    ...
    def __init__(self, client, timeout=60, should_skip=True):
        ...
        self.other_params = 'jednosoban-stan/izdavanje-prodaja/izdavanje/zemlja/srbija/cena/100_250/lista/po_stranici/20/?search%5Bcategory%5D%5B0%5D=12&search%5Bcategory%5D%5B1%5D=9'
        self.client = client
